...
// Apply only the swagger downloader script
...
// OpenAPI Generator configuration (moved from external script)
openApiGenerate {
    ...
    // Generator options - UPDATE THIS LINE
    configOptions.set(mapOf(
        "library" to "jvm-retrofit2", // Changed from "retrofit2" to "jvm-retrofit2"
...
// Create a standalone task for easier command-line use
